...
io.on('connection', (socket) => {
    ...
    socket.on('request-join', (roomId, userId) => {
        ...
        // Since we don't strictly track roles in server memory, broadcasting to room works if only teacher is there initially
        // Or we can broadcast to all and client filters.
